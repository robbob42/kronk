...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const startScreensaver = () => {
        ...
        document.body.classList.add('screensaver-active'); // <-- ADD THIS LINE
        showRandomContent();
        screensaverInterval = setInterval(showRandomContent, CONTENT_CHANGE_INTERVAL);
    };
    const stopScreensaver = () => {
        screensaver.style.display = 'none';
        document.body.classList.remove('screensaver-active'); // <-- ADD THIS LINE
